...
export default function BuildTripTime({ trip, handleClick, setShowNext }) {
    React.useEffect(() => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TimeButton 
                ...
                subText="12PM-6PM" 
                handleClick={() => {
                    handleClick('afternoon')                    
                }} 
                state={trip.time.afternoon}
            />
            <TimeButton 
                icon="sunset" 
                text="Evening" 
