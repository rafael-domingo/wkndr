...
import { StyleSheet, View, Pressable, TextInput, Text, Button, Animated, Easing, TouchableOpacity, Dimensions } from 'react-native';
    ...
    return (
        <View style={styles.container}>  
            <View style={{flexDirection: 'row', width: '100%', alignItems: 'center', justifyContent: 'center'}}>
                <Animated.View style={{height: '100%',justifyContent: 'center', opacity: 1}}>                
                    <TouchableOpacity                        
